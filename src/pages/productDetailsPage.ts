...
export class ProductDetailsPage {
  ...
  constructor(page: Page) {
    ...
    this.productAvailability = this.productInformation.locator('p', {
      hasText: 'Availability:',
    })

    this.productCondition = this.productInformation.locator('p', {
      hasText: 'Condition:',
    })

    this.productBrand = this.productInformation.locator('p', {
      hasText: 'Brand:',
    })
    ...
    this.writeYourReviewText = this.shopDetailsTab.getByRole('link', {
    ...
    this.submitButton = this.shopDetailsTab.getByRole('button', {
      name: /submit/i,
    })
  }
}
